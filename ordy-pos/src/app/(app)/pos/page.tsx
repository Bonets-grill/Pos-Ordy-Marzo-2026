...
import { Search, Plus, Minus, Trash2, X, CheckCircle, Split, Clock, ChevronDown, Users, ListChecks } from "lucide-react";
...
export default function PosPage() {
  ...
  /* ── Pay (same as send but status = paid) ────────────── */
        ...
        >
          <div
            style={{
              display: "flex",
              gap: 6,
              marginBottom: orderType === "dine_in" ? 10 : 0,
            }}
          >
            {(
              [
                { key: "dine_in", label: "pos.dine_in" },
                { key: "takeaway", label: "pos.takeaway" },
                { key: "delivery", label: "pos.delivery" },
              ] as const
            ).map((ot) => (
              <button
                key={ot.key}
                ...
                style={{
                  ...
                  cursor: "pointer",
                  background:
                    orderType === ot.key ? "var(--accent)" : "var(--bg-card)",
                  color:
                    orderType === ot.key ? "#000" : "var(--text-secondary)",
                  transition: "all 0.15s",
                }}
              >
                {t(ot.label)}
              ...
              style={{
                ...
                background:
                  sending || cart.length === 0
                    ...
                    : "var(--accent)",
                color:
                  sending || cart.length === 0 ? "var(--text-secondary)" : "#000",
